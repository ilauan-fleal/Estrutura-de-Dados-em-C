...
//LISTA ENCADEADA PARA NÚMEROS INTEIROS!
...
int tam = 1;
//CRIANDO FUNÇÃO PARA INICIALIZAR A LISTA ENCADEADA!
...
int main(){
    ...
    do{
        ...
        switch(escolha){
            ...
            printf("Nó removido do início: %d\n", temp->numbers);
            break;
            case 6:
            temp = RetiraDoFinal(LISTA);
            printf("Nó removido do final: %d\n", temp->numbers);
            break;
            case 7:
            Inserir(LISTA);
            break;
            case 8:
            temp = Retira(LISTA);
            printf("O elemento %d foi retirado da posição em questão\n", temp->numbers);
            break;
            case 0:
            printf("Saindo...\n");
            exit(EXIT_SUCCESS);
